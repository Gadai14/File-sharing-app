...
function UploadForm({uploadBtnClick,progress}) {
    ...
    items-center justify-center w-full h-64 border-2
     ...
     rounded-lg cursor-pointer
      bg-blue-10 dark:hover:bg-gray-300
      hover:border-blue-100
        hover:bg-gray-900 dark:hover:border-gray-100
        ">
                    <div className="flex flex-col items-center 
        justify-center pt-5 pb-6">
                        <svg className="w-12 h-12 mb-4 text-blue-500 dark:text-blue-700" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
             ...
             dark:text-gray-500 ">
                            <span className="font-semibold md:text-1.5xl">
                                Click to upload </span>
                             or <strong className=' text-2xl text-blue-600' >
                                drag</strong> and <strong className='text-2xl text-blue-600'>drop</strong></p>
           ...
           {progress>0? <ProgressBar progress={progress} />:
            ...
            w-[30%] rounded-full mt-5 disabled:bg-gray-500'
